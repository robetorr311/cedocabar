    ...
    public partial class Morbilidad : System.Web.UI.Page
    {
        ...
        protected void Continuar(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string idexamenf = conexion.insexamenf(idpac, vfecha.Value, ta.Text, fc.Text, fr.Text, peso.Text, talla.Text, temperatura.Text, "archivo", aspecto.Text, iddoc,"2","NULL");
                string hmedico = (string)this.Session["hmedico"];
