<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DatosPaciente.aspx.cs" Inherits="cedocabar.CardiologiaInf.DatosPaciente" %>
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="center" class="loginDisplay" >
          <asp:Button ID="Button1" OnClick="Modificar" CssClass="buttons2" runat="server"  Text="Modificar" />
