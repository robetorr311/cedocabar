            ...
            if (Session["Session"] != null)
            {
                ...
                if (paciente.Rows.Count > 0)
                {
                    for (int dd = 0; dd < paciente.Rows.Count; dd++)
                    {
                        ...
                        ReGdireccion = paciente.Rows[dd]["direccion"].ToString();
                        ReGcorreo = paciente.Rows[dd]["correo"].ToString();
                        ReGtelefonov = paciente.Rows[dd]["telefonov"].ToString();
                        ...
                        ReGherenciap = paciente.Rows[dd]["herenciap"].ToString();
                        ReGherenciam = paciente.Rows[dd]["herenciam"].ToString();
                        ReGherenciah = paciente.Rows[dd]["herenciah"].ToString();
