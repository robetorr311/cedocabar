<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false"  CodeBehind="ExamenF.aspx.cs" Inherits="cedocabar.CardiologiaInf.ExamenF" %>
...
<body>
    ...
    <table width="700" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td align="center" class="nombreform">
                    <asp:Label ID="Label1" CssClass="main" runat="server" Text="CONSULTA CARDIOLOGIA INFANTIL"></asp:Label>
                </td>
            </tr>
     </table>
    <table width="700" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td align="left" class="loginDisplay"><asp:TextBox ID="ta" runat="server"></asp:TextBox></td>
      ...
      <td align="left" class="loginDisplay"><asp:TextBox ID="fc" runat="server"></asp:TextBox></td>
      ...
      <td align="left" class="loginDisplay"><asp:TextBox ID="fr" runat="server"></asp:TextBox></td>
    ...
    <tr>
      ...
      <td align="left" class="loginDisplay"><asp:TextBox ID="peso" runat="server"></asp:TextBox></td>
      ...
      <td align="left" class="loginDisplay"><asp:TextBox ID="talla" runat="server"></asp:TextBox></td>
      ...
      <td align="left" class="loginDisplay"><asp:TextBox ID="temperatura" runat="server"></asp:TextBox></td>
    ...
    <tr>
      ...
      <td align="left" class="loginDisplay"><asp:TextBox ID="aspecto" TextMode="MultiLine" runat="server"></asp:TextBox></td>
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>      
      ...
      <asp:Button ID="Button2" CssClass="buttons2" OnClick="Cancelar" runat="server" Text="Cancelar" />
      </td>
    </tr>
  </table>  
