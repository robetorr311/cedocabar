<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insert.aspx.cs" Inherits="cedocabar.CardiologiaInf.Insert" %>
...
<body>
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    ...
    <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" class="loginDisplay"><asp:Label ID="tratamiento" runat="server" Text=""></asp:Label></td>
