<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Morbilidad.aspx.cs" Inherits="cedocabar.CardiologiaInf.Morbilidad" %>
...
<body>
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    ...
    <table width="700" border="0" cellspacing="0" cellpadding="0">
      <tr>
         <td align="center"  class="subnombreform" >MOTIVO DE LA CONSULTA</td>
      </tr>
    </table>
    <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" class="loginDisplay"><asp:TextBox ID="motivo" CssClass="textolargo" TextMode="MultiLine" runat="server"></asp:TextBox></td>
     ...
     <table width="700" border="0" cellspacing="0" cellpadding="0">
      <tr>
         <td align="center"  class="subnombreform" >ENFERMEDAD ACTUAL</td>
      </tr>
    </table>    
    <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" class="loginDisplay"><asp:TextBox ID="enfermedad" CssClass="textolargo" TextMode="MultiLine" runat="server"></asp:TextBox></td>
