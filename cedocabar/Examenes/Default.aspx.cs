...
namespace cedocabar.Examenes
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            DBConnect conector = new DBConnect();
            DataTable datos = conector.SExamenes();
        ...
        protected void gridView_DeletedIndex(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                conector.dexamenes(HiddenField1.Value);
                FillCustomerInGrid();
                Label1.Text = "";
                HiddenField1.Value = "";
            }
        ...
        protected void upd(object sender, GridViewUpdateEventArgs e)
        {
            ...
            conector.uGExamenes(LblID.Text,
                              TBXnombre.Text,
                              TBXcodigo.Text);
            GridView1.EditIndex = -1;
            FillCustomerInGrid();
        ...
        {
            DBConnect conector = new DBConnect();
            conector.uExamenes(HiddenField1.Value,
                nombre.Text,
                codigo.Text);
