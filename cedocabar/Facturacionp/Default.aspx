<%@ Page Language="C#"   AutoEventWireup="true" ValidateRequest="false" CodeBehind="Default.aspx.cs" Inherits="cedocabar.Facturacionp.Default" %>
...
<form id="form1" target="_self" runat="server">      
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="center" class="nombreform"><asp:Label ID="Label1" CssClass="main" runat="server" Text="FACTURACION DE PRUEBAS"></asp:Label></td>
    </tr>
  </table>                   
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
   ...
   <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td align="left" class="loginDisplay"><asp:DropDownList ID="servicio" AutoPostBack="true"  OnSelectedIndexChanged="callMedicoserv" runat="server"></asp:DropDownList></td>
