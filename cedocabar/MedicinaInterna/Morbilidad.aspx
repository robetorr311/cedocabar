<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Morbilidad.aspx.cs" Inherits="cedocabar.MedicinaInterna.Morbilidad" %>
    ...
    <table width="700" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td align="center" class="nombreform">
                    <asp:Label ID="Label1" CssClass="main" runat="server" Text="CONSULTA INTERNISTA"></asp:Label>
                </td>
            </tr>
     </table>
    <table width="700" border="0" cellspacing="0" cellpadding="0">
