    ...
    public partial class Morbilidad : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["Session"] != null)
            {
                if (!IsPostBack)
                {
                    ...
                    string modal10 = "showPopWin('ECG.aspx?hpaciente=" + vhpaciente.Value + "', 800, 400);";
                    Button2.Attributes.Add("onclick", modal9);
                    Button4.Attributes.Add("onclick", modal10);
        ...
        protected void Continuar(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string idexamenf = conexion.insexamenf(idpac, vfecha.Value, ta.Text, fc.Text, fr.Text, peso.Text, talla.Text, temperatura.Text, "archivo", aspecto.Text, iddoc,"14","NULL");
                string hmedico = (string)this.Session["hmedico"];
                string idmorb = conexion.imedicinainterna(idpac, motivo.Text, enfermedad.Text, diagnostico.Text, tratamiento.Text, iddoc, idexamenf, hmedico);
