<%@ Page Language="C#"  AutoEventWireup="true" ValidateRequest="false" CodeBehind="Default.aspx.cs" Inherits="cedocabar.Medicos.Default" %>
...
<body onload="cargar()">
       ...
       <table width="700" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td align="center" class="nombreform">
                    <asp:Label ID="Label1" CssClass="main" runat="server" Text="FORMULARIO PARA EL INGRESO DE MEDICOS"></asp:Label>
                </td>
            </tr>
        </table>                   
  <table width="700" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" class="loginDisplay"  width="97">Nro. MPPS: </td>
      <td align="left" class="loginDisplay"><asp:TextBox ID="mpps" runat="server"></asp:TextBox></td>
      <td align="left" class="loginDisplay"  width="2"><asp:Label ID="LblV3" runat="server" Text=""></asp:Label></td>
      <td align="left" class="loginDisplay"width="20"><img onmouseover="muestraAyuda(event, 'Numero MPPS');" id="Img3" src="~/Imagenes/sign_question.png" alt="" width="16" height="16" runat="server"/></td>
      <td align="left" class="loginDisplay" width="86">Nro. Colegio: </td>
      <td align="left" class="loginDisplay"><asp:TextBox ID="colegio" runat="server"></asp:TextBox></td>
      <td align="left" class="loginDisplay" width="2"><asp:Label ID="LblV4" runat="server" Text=""></asp:Label></td>
      <td align="left" class="loginDisplay"width="20"><img onmouseover="muestraAyuda(event, 'Numero Colegio de Medicos');" id="Img4" src="~/Imagenes/sign_question.png" alt="" width="16" height="16" runat="server"/></td>
    </tr>
  </table>
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" class="loginDisplay" >Servicios:</td>
      <td align="left" class="loginDisplay" >
      <input type="button" ID="Button5" runat="server"  class="buttons2" value="Servicios" />
      <input type="button" ID="Button6" runat="server"  class="buttons2" value="Servicios" />
      </td>
      <td align="left" class="loginDisplay" width="2"><asp:Label ID="Label3" runat="server" Text=""></asp:Label></td>
      <td align="left" class="loginDisplay"width="20"><img onmouseover="muestraAyuda(event, 'Servicios');" id="Img5" src="~/Imagenes/sign_question.png" alt="" width="16" height="16" runat="server"/></td>
    </tr>
  </table>
  <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <tr>
            <td  class="loginDisplay">
                <asp:GridView ID="GridView1" 
                    ...
                    <asp:TemplateField HeaderText="M.P.P.S." Visible="true">					
						<ItemTemplate>
                            <asp:Label ID="Lblmpps" runat="server" Text='<%# Eval("mpps") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="TBXmpps" CssClass="textboxgrid" runat="server" Text='<%# Eval("mpps") %>'></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Colegio" Visible="true">					
						<ItemTemplate>
                            <asp:Label ID="Lblcolegio" runat="server" Text='<%# Eval("colegio") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="TBXcolegio" CssClass="textboxgrid" runat="server" Text='<%# Eval("colegio") %>'></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
