<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="org_geografica.aspx.cs" Inherits="cedocabar.Medicos.org_geografica" %>
  ...
  <table width="500" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="center" class="loginDisplay" >
          <asp:Button ID="Button1" CssClass="buttons2" onmouseover="" OnClientClick="" runat="server" Text="Cerrar" />
      </td>
    </tr>
  </table>
