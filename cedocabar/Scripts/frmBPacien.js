...
function hidePopWin(callReturnFunc, valor1, valor2, valor3,valor4) {
    ...
    document.getElementById("form1").cedula.value = valor1;
    document.getElementById("form1").historia.value = valor2;
    document.getElementById("form1").paciente.value = valor3;
    document.getElementById("form1").idpaciente.value = valor4;
} 
