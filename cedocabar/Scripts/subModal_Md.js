...
*/
function hidePopWin(callReturnFunc,valor1,valor2) {
    gPopupIsShown = false;
    var theBody = document.getElementsByTagName("BODY")[0];
    ...
    document.getElementById("form1").TextBox1.value = valor1;
    document.getElementById("form1").num_region.value = valor2;
}
