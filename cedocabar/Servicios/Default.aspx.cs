...
namespace cedocabar.Servicios
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            DBConnect conector = new DBConnect();
            DataTable datos = conector.SServicios();
        ...
        protected void gridView_DeletedIndex(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                conector.dservicios(HiddenField1.Value);
                FillCustomerInGrid();
                Label1.Text = "";
                HiddenField1.Value = "";
            }
        ...
        protected void Borrar(object sender, GridViewDeleteEventArgs e)
        {
            ...
            DBConnect conector = new DBConnect();
            conector.dservicios(LblID.Text);
            FillCustomerInGrid();
        }
        protected void upd(object sender, GridViewUpdateEventArgs e)
        {
            ...
            conector.uGservicios(LblID.Text,
                              TBXnombre.Text,
                              TBXcodigo.Text);
            GridView1.EditIndex = -1;
            FillCustomerInGrid();
        ...
        protected void Save(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("Registro"))
            {
                ...
                DataTable medicos = conector.Sservicio_IND(id);
        ...
        {
            DBConnect conector = new DBConnect();
            conector.uservicios(HiddenField1.Value,
                nombre.Text,
                codigo.Text);
