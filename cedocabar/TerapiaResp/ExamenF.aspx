<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false"  CodeBehind="ExamenF.aspx.cs" Inherits="cedocabar.TerapiaResp.ExamenF" %>
...
<body>
    ...
    <tr>
      ...
      <td align="left" class="loginDisplay"><asp:TextBox ID="sao2" runat="server"></asp:TextBox></td>
