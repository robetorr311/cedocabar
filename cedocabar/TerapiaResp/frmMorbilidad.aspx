<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMorbilidad.aspx.cs" Inherits="cedocabar.TerapiaResp.frmMorbilidad" %>
...
<body>
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0">
   ...
   <table width="700" border="0" cellspacing="0" cellpadding="0">
    ...
    <table width="700" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" class="loginDisplay"><asp:TextBox ID="terapia" CssClass="textolargo" TextMode="MultiLine" runat="server"></asp:TextBox></td>
