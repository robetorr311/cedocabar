<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="denegado.aspx.cs" Inherits="cedocabar.denegado" %>
       ...
       <table width="500" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td align="center" class="nombreform">
                    <asp:Label ID="Label4" CssClass="main" runat="server" Text="PROBLEMAS PARA INGRESAR"></asp:Label>
                </td>
            </tr>
        </table>
